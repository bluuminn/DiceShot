    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/DiceShot/smarteditor/sample/photo_uploader/file_uploader_html5.php'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/DiceShot/smarteditor/sample/photo_uploader/file_uploader.php',	//샘플 URL입니다.
 	        sCallback : 'DiceShot/smarteditor/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
