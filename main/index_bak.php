    ...
    <main>
      ...
      <nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="../index_bk.html">
                  <img src="../images/diceshot/icon/logo/diceshot_logo.png" alt="Dice Shot" style="width: 140px; height: auto">
              </a>
          </div>
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">전체</a>
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Pages</a>
                <ul class="dropdown-menu">
                  ...
                  <li><a href="../member/sign_in.php">Login / Register</a></li>
                ...
                <ul class="dropdown-menu" role="menu">
                  ...
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Grid</a>
                    <ul class="dropdown-menu">
                      ...
                      <li><a href="../product/no_product_list.php">4 Columns</a></li>
                    </ul>
                  </li>
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Masonry</a>
                    <ul class="dropdown-menu">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Product</a>
                    <ul class="dropdown-menu">
                      ...
                      <li><a href="../product/product_list.php">4 columns</a></li>
                    </ul>
                  </li>
                  <li><a href="../product/detail_product.php">Single Product</a></li>
                  <li><a href="../member/checkout.php">Checkout</a></li>
                </ul>
              </li>
      ...
      <section class="home-section home-parallax home-fade" id="home">
        <div class="hero-slider">
          <ul class="slides">
            <li class="bg-dark-30 bg-dark" style="background-image:url('../images/diceshot/main_slide/rummikub2.jpg');">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-1">Hello &amp; welcome</div>
                  <div class="font-alt mb-40 titan-title-size-4">We are Dice Shot</div><a class="section-scroll btn btn-border-w btn-round" href="#about">Learn More</a>
                </div>
              </div>
            </li>
            <li class="bg-dark-30 bg-dark" style="background-image:url('../images/diceshot/main_slide/drecksau.jpg');">
              <div class="titan-caption">
                <div class="caption-content">
            ...
            <li class="bg-dark-30 bg-dark" style="background-image:url('../images/diceshot/main_slide/weykick.jpg');">
              <div class="titan-caption">
                <div class="caption-content">
        ...
        <div class="main">
            ...
            <footer class="footer bg-dark">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <p class="copyright font-alt">&copy; 2017&nbsp;<a href="../index_bk.html">TitaN</a>, All Rights Reserved</p>
                        </div>
                        <div class="col-sm-6">
                            <div class="footer-social-links"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-dribbble"></i></a><a href="#"><i class="fa fa-skype"></i></a>
                            </div>
